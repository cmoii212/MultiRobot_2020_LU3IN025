...
verbose = True # permet d'afficher le suivi des agents (informations dans la console)
    ...
    def stepController(self):
        ...
        if verbose == True:
	        ...
	        for i in range(len(SensorBelt)):
	            ...
	            print ("\t\tRobot info:",self.getRobotInfoAtSensor(i)) # dict("id","centroid(x,y)","orientation","teamname") (si pas de robot: renvoi "None" et affiche un avertissement dans la console
    ...
    def stepController(self):
        ...
        if verbose == True:
	        ...
	        for i in range(8):
	            ...
	            print ("\t\tRobot info:",self.getRobotInfoAtSensor(i)) # dict("id","centroid(x,y)","orientation","teamname") (if not a robot: returns None and display a warning)
